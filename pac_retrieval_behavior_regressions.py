#!/usr/bin/env python
"""
Patient-level regressions between retrieval PAC baseline values and memory
modulation (avg_stim_dprime_diff).

Baseline PAC measure:
1. Average retrieval PAC within each patient and region pair across all
   retrieval trials to obtain one mean PAC spectrum.
...
from BLAES_Group_PAC_analyses_from_matlab_retrieval import PAC_BANDS, load_blaes_retrieval_pac
