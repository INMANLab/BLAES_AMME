...
def build_markdown(rows, slides_dir: Path) -> str:
    lines = [
        "---",
        "title: Encoding MLMR Summary",
        "---",
    ]

    measure_dirs = {
        "Power": STATS_ROOT / "encoding_power",
        "Coherence": STATS_ROOT / "encoding_coherence",
    }
...
def main():
    ...
    manifests = [
        (STATS_ROOT / "encoding_power" / "manifest.csv", "Power"),
        (STATS_ROOT / "encoding_coherence" / "manifest.csv", "Coherence"),
    ]
    ...
    markdown_path = SLIDES_ROOT / "encoding_mlmr_summary.md"
    pptx_path = SLIDES_ROOT / "encoding_mlmr_summary.pptx"
