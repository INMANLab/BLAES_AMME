#!/usr/bin/env python
"""Combined PAC retrieval analysis for BLAES, AMME, and all subjects."""
...
OUTPUT_BASE = SCRIPT_DIR.parent / 'OUTPUTS' / 'retrieval_pac'
...
def main():
    print('=' * 60)
    print('Combined PAC Retrieval Analysis')
    print('=' * 60)
    ...
    print('\n' + '=' * 60)
    print('Done! PAC retrieval outputs saved to:', OUTPUT_BASE)
    print('=' * 60)
