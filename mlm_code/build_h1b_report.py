...
run_h1b_lmm_retrieval.R or run_h1b_glmm_retrieval.R.

Usage:
  python build_h1b_report.py <lmm|glmm> <balanced|imbalanced>
...
if len(sys.argv) < 3:
    print("Usage: python build_h1b_report.py <lmm|glmm> <balanced|imbalanced>")
    sys.exit(1)
...
DATA_DIR = os.path.join(SCRIPT_DIR, "outputs", f"h1b_{KIND}_{FILTER}_retrieval_mlm")
...
OUTPUT_PDF = os.path.join(
    SCRIPT_DIR, "outputs",
    f"Hypothesis_1b_Report_{KIND.upper()}_Retrieval_{FILTER_LABEL.replace(' ', '_')}.pdf",
)
