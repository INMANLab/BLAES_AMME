#!/usr/bin/env python3
"""
Build APA-formatted PDF reports for encoding Stim x Sex GLMM analyses.
Matches the layout of the encoding/encoding memory reports.
...
STATS_ROOT = SCRIPT_DIR / "outputs" / "stim_sex_glmm" / "encoding" / "stats"
OUTPUT_ROOT = SCRIPT_DIR / "outputs" / "stim_sex_glmm" / "encoding"
...
def write_report(measure_slug):
    ...
    est_label = "OR"
    stat_label = "z"
    report_title = f"Encoding {measure_label} - Stim x Sex GLMM"
    out_path = OUTPUT_ROOT / f"Encoding_{measure_label}_Stim_x_Sex_GLMM_Report.pdf"
    ...
    pdf.subtitle("Encoding Phase - Stim x Sex GLMM - Balanced Trials")
